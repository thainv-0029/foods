...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('admin_pages_assets/vendors/bootstrap/dist/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('admin_pages_assets/vendors/font-awesome/css/font-awesome.min.css') }}">
    <link rel="stylesheet" href="{{ asset('admin_pages_assets/vendors/themify-icons/css/themify-icons.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('admin_pages_assets/assets/css/style.css') }}">
    ...
    <div id="right-panel" class="right-panel">
        ...
        <header id="header" class="header">
            ...
            <div class="header-menu">
                ...
                <div class="col-sm-7">
                    <a id="menuToggle" class="menutoggle pull-left"><i class="fa fa fa-angle-double-left"></i></a>
